...
<div id="content">
  ...
  <div class="container-fluid">
      <h3>Kelola Data Santri</h3>
      <a class="btn btn-default pull-right" href="<?php echo site_url('santri/addsantri') ?>">Tambah Data Santri</a>
    <div class="row-fluid">
    <div class="span12">
      <div class="widget-box">
          <div class="widget-title">
             <span class="icon"><i class="icon-th"></i></span> 
            <h5>Kelola Data Santri</h5>
          </div>
          ...
          <?php foreach ($santri as $key) { ?>
            <tr>
              ...
              <td><?php echo $key->nama_asrama ?> - <?php echo $key->gedung ?></td>
              <td><?php echo $key->total_paket ?></td>
              <td>
                <a class="btn btn-primary" href="<?php echo site_url('santri/editsantri/'.$key->id_santri) ?>">Edit</a>
                <a class="btn btn-danger" href="<?php echo site_url('santri/deletesantri/'.$key->id_santri) ?>">Delete</a>
              </td>
              <?php $no++ ?>
            </tr>
          <?php } ?>
